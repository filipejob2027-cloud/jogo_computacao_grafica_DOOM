 ...
 * GUIA RÁPIDO
 * ------------------------------------------------------------------
 * Este ficheiro centraliza o estado do jogo.
 *
 * Onde mexer:
 * - Dificuldade: `applyDifficulty()` (multiplicadores de dano/vida/velocidade).
 * - Spawn por nível: `getSpawnCellForLevel()` + `applySpawnForLevel()`.
 * - Propriedades do jogador: `player` (altura, yaw/pitch, salto).
 * - Progressão por ondas: `G.wave` (lida pelo combate/spawn).
 */
export const G = {
  health: 100,
  armor: 50,
