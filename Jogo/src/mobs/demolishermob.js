 ...
 * ------------------------------------------------------------------
 * Boss "cérebro + pernas mecânicas":
 * 1) Tamanho global: `DEMOLISHER_SCALE` em `systems/enemies.js`.
 * 2) Chassis e corpo mecânico:
 *    - `chassis`, `bellyPlate`, `spine`, `neckRing`.
 * 3) Pernas mecânicas:
 *    - função `buildSpiderLeg()` (raio/altura dos segmentos e juntas).
 * 4) Cérebro e olhos:
 *    - hemisférios: `brainLeft` / `brainRight`
 *    - olho principal: `bossEye`
 *    - olhos laterais: bloco `forEach` com `sEye`
 * 5) Arma:
 *    - base: `turretBase`
 *    - canos: bloco dos cilindros `b`
 *    - bocal: `muzzle`
 * 6) Animação:
 *    - `applyWalkPhase()` controla bob, marcha das pernas e brilho emissivo.
 */
