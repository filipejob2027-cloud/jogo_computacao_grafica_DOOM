 ...
 * ------------------------------------------------------------------
 * 1) Tamanho global do Imp: `IMP_SCALE` em `systems/enemies.js`.
 * 2) Texturas procedurais:
 *    - `makeSkinTexture`, `makeRoughnessMap`, `makeNormalMap`.
 * 3) Partes do corpo (pelvis, torso, cabeça, braços, pernas) na criação do modelo.
 * 4) Olhos e brilho: `eyeMat` / `eyeGlowM`.
 * 5) Para adicionar olhos/chifres:
 *    - duplica os meshes da cabeça e altera `position`.
 * 6) Animação: função `update(dt, moving)` no final do ficheiro.
 */
