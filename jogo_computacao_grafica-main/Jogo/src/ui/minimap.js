export function createMinimap(mapOrGetter, cell, enemies, player) {
   ...
   *
   * Onde mexer:
   * - Cores (paredes/ácido/inimigos/jogador): `fillStyle` dentro de `drawMinimap()`.
   * - Tamanho do "ponto" do jogador/inimigos: `fillRect(...)` e `arc(...)`.
   * - Alcance do indicador de direção: linha em `lineTo(...)`.
   */
