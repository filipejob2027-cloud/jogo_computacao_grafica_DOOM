 ...
 * ------------------------------------------------------------------
 * Este é o modelo do jogador para Lore/representação.
 * 1) Tamanho global: `marine.applyScale(...)` onde o mob é instanciado.
 * 2) Pernas: `buildLeg()` (thigh, knee, shin, botas).
 * 3) Tronco/armadura: blocos `waist`, `abdoPanel`, peito e ombros.
 * 4) Cabeça/visor: secção da cabeça (skull/head/visor).
 * 5) Braços: blocos de braço esquerdo/direito (útil para ajustar proporções).
 * 6) Animação: função `animate(...)` no fim do ficheiro.
 */
