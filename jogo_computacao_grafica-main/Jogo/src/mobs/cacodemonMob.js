 ...
 * ------------------------------------------------------------------
 * 1) Tamanho global: `CACO_SCALE` em `systems/enemies.js`.
 * 2) Corpo principal: geometrias centrais na função `createCacodemonMob()`.
 * 3) Dentes: função `addTooth(...)` (forma, rotação e distribuição).
 * 4) Chifres: função `buildHorn(...)`.
 * 5) Olho principal:
 *    - esclera/íris/pupila (materiais e geometrias de olho).
 * 6) Animação de flutuação: função `applyFloatAnimation(...)`.
 */
